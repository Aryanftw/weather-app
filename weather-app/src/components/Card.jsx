...
const Card = ({handleChange,handleSubmit,city,input,temp,error,humidity,windspeed}) => {
  return (
    ...
    ,border:"2px solid white"}}>
      ...
      input={input}/>
      <Info city={city}temp={temp}error={error}humidity={humidity}windspeed={windspeed}/>
    </div>
  )
}
